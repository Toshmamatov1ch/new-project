...
function Button({ text, variant, icon, onclick }) {
  const variants = {
    primary:
      "py-2.5 px-4 bg-indigo-600 text-white rounded-2xl w-full md:py-2.5 px-4 bg-indigo-600 text-white rounded-2xl",
    secondary:
    ...
    danger:
      "px-8 py-3 bg-white text-[#0f172a] font-semibold text-lg rounded-2xl border border-[#e2e8f0] shadow-sm hover:bg-slate-50 active:scale-95 transition-all flex itmes-center gap-2 ",
  };
  return (
